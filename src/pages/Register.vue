        ...
        <form @submit.prevent="handleSubmit" class="form-signin">
            ...
            <div class="form-group">
                ...
                <input :class="{ 'is-invalid': submitted && errors.has('firstName') }" class="form-control"
                       name="firstName" placeholder="Ex. Ivan" type="text" v-model="user.firstName"
                       v-validate="'required'"/>
            ...
            <div class="form-group">
                ...
                <input :class="{ 'is-invalid': submitted && errors.has('lastName') }" class="form-control"
                       name="lastName" placeholder="Ex. Ivanov" type="text" v-model="user.lastName"
                       v-validate="'required'"/>
            ...
            <div class="form-group">
                <button :disabled="auth.registering" class="btn btn-primary">Register</button>
                <img
